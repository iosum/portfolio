const DATA = {
    ...
    bio: "Hello world, I am Chia-Ying Ho. From Tawian 🇹🇼. Graduated from Ming Chuan University with a BS Degree in CS, but realize I am a huge fan of web development. I have studied @ Georgian College as a COmputer Studies student in Barrie, Ontaio, Canada.  From 2020 January to 2020 June, I have developed a report application with Java Swing as a student developer. In free time, I built an small E-commerce with React and firebase. Also done a small boba shop shopping system with ASP.NET Core 3.1 with Razor pages. Hummmm....💭 That\"s pretty much about me! Feel free to reach out to me on LinkedIn and Github! Look forward to meeting you!😄",
    socialMedias: {
    ...
    projects: [
        {
            ...
            imageUrl: "https://i.ibb.co/tLH0b94/crwn-clothing.png"
        },
        {
            id: 8,
            name: "Boba Shop",
            ...
            buttonName: "Github",
            imageUrl: "https://i.ibb.co/jwWn3nb/boba.png"
        }
    ]
};
